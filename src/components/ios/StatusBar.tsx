  ...
  return (
    <div style={{
      ...
      <div style={{ position: 'absolute', left: 24, display: 'flex', alignItems: 'center' }}>
        <span style={{ fontFamily: '-apple-system, "SF Pro"', fontWeight: 590, fontSize: 16, lineHeight: '22px', color: '#fff' }}>
          {time}
        </span>
      </div>
      <div style={{ position: 'absolute', right: 24, display: 'flex', alignItems: 'center', gap: 7 }}>
        {/* Signal */}
        ...
        <svg width="27" height="13" viewBox="0 0 27 13">
          <rect x="0.5" y="0.5" width="23" height="12" rx="3.5" stroke="rgba(255,255,255,0.35)" fill="none"/>
          <rect x="2" y="2" width="20" height="9" rx="2" fill="#fff"/>
          <path d="M25 4.5V8.5C25.8 8.2 26.5 7.2 26.5 6.5C26.5 5.8 25.8 4.8 25 4.5Z" fill="rgba(255,255,255,0.4)"/>
        </svg>
      </div>
    </div>
  );
